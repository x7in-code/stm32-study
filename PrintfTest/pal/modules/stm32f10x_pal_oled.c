...
static void DrawCharator(PalOled_HandleTypeDef *Handle, const uint32_t Unicode);
...
void PAL_OLED_DrawCharator(PalOled_HandleTypeDef *Handle, const char Ch)
{
	DrawCharator(Handle, Ch);
}
